...
In order to initialize PostgreSQL database, generate your main _user_ and a _password_ and import your data from CouchDB (if it's the case), run the following command:
...
If you want to manually import the data from CouchDB, follow this [step](https://github.com/infobyte/faraday/wiki/Installation-Pro/_edit#manually-importing-from-couchdb)
